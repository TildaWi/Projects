...
**문제 정의 |** 상품별 주문 빈도를 기준으로 ABC 등급 분류 모델(Random Forest) 을 설계하고, 최적 진열 시뮬레이션을 통해 효율성을 분석 <br/>
**결과 |** 최적 진열 적용 시 **피킹 이동 거리 35.3%↓, 전체 처리 시간 19.5%↓, 작업자 생산성 24.2%↑**로 운영 효율성 개선 확인 <br/>
